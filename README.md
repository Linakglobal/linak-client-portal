...
![LINAK Client Portal## 🧪 Dev Fixtures

For development and testing, this project includes demo data fixtures and a seed script.
...
2. **Insert Demo Data**:
   ...
   - Paste and execute the INSERT statements

3. **Demo Users**:
   - `demo@linak.com` - Demo User (client role)
   - `admin@linak.com` - Admin User (admin role)  
   - `client@linak.com` - Client User (client role)
...
- `fixtures/users.json` - Demo user data
- `fixtures/documents.json` - Sample document metadata
- `scripts/seed-dev.mjs` - SQL generation script

### Important Notes

⚠️ **Non-Production Only**: These fixtures are for development/testing only
